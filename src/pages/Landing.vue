<template>
    ...
    <div class="bg-white -translate-y-16 z-20 relative rounded-xl shadow-xl p-6 mx-4 mt-4">
        <section class="flex flex-col gap-4">
            <div class="flex gap-4 items-center">
                <img alt="Vue logo" src="../assets/logo/subwa.svg" class="h-8 flex-1" />
                <h1 class="flex-1 text-[20px] font-bold leading-[24px]">Subwa Family Restaurant</h1>
            </div>
            <div class="flex flex-col gap-2">
                <div class="flex gap-4 items-center">
                    <FontAwesomeIcon :icon="faPhone" class="text-base" />
                    <h1 class="flex-1 text-[16px] font-light leading-[24px]">0861-8291-8281</h1>
                </div>
                <div class="flex gap-4 items-center">
                    <FontAwesomeIcon :icon="faClock" class="text-base" />
                    <div class="flex-1 flex justify-between">
                        <h1 class="text-[16px] font-light leading-[24px]">Tuesday 9AM - 9PM</h1>
            ...
            <form class="flex flex-col gap-1 mt-2" @submit.prevent="submit">
                <label class="form-control w-full">
                    ...
                    <input type="text" placeholder="08XX-XXXX-XXXX" class="input input-bordered w-full" />
                </label>
                <label class="form-control w-full">
                    <div class="label font-bold">
...
import { faChevronDown, faPhone, faClock, faLocationDot } from "@fortawesome/free-solid-svg-icons";
