    ...
    <div class="bg-white relative p-6">
        <section class="flex flex-col gap-4">
            <div class="flex flex-col gap-4">
                <h1 class="text-xl font-bold">Product's Name</h1>
                <h6 class="text-base text-gray-500">Short Description</h6>
                <div class="border-b-2 pb-4 border-dashed">
                    <p class="text-base font-bold">IDR 10.000</p>
                    <div class="flex gap-2">
                        <p class="text-base line-through">IDR 50.000</p>
                        <span class="text-[#EB5757]">50%</span>
                    </div>
                </div>
            </div>
            <div class="flex flex-col gap-4">
                <h1 class="text-xl font-bold">Sides (optional)</h1>
                <div class="border-b-2 pb-4 border-dashed flex flex-col gap-4">
                    <div class="flex justify-between items-center">
                        <p class="text-base">Hashbrown</p>
                    ...
                    <div class="flex justify-between items-center">
                        <p class="text-base">French Fries</p>
                        <div class="flex gap-2 items-center">
                            +12.000
                            <input type="checkbox" class="checkbox" />
                        </div>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center gap-2">
                    ...
                    <input type="text" placeholder="Total" value="1" class="input input-bordered w-full text-center" />
                    <AtomsButton type="primary" class="w-full py-[11px]"> + </AtomsButton>
                </div>
            </div>
            <AtomsButton type="primary" class="w-full mt-4"> Add to Cart </AtomsButton>
        </section>
    </div>
</template>
